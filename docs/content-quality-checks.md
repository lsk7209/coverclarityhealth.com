...
- project operation files: `package.json`, `vercel.json`, `README.md`, the GitHub content-quality workflow, the scheduled publishing workflow, and launch CI status check with scheduled-run freshness
